...
function App() {
  const [pictures, setPictures] = useState([
    { id: 1, name: 'Bitcoin', price: 0.1, url: '/images/bitcoin.jpg' },
    { id: 2, name: 'Ethereum', price: 0.2, url: '/images/ethereum.jpg' },
    { id: 3, name: 'Solana', price: 0.3, url: '/images/solana.jpeg' },
    { id: 4, name: 'Bnb', price: 0.35, url: '/images/bnb.png' },
  ]);
